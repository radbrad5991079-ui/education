...
const GlassCard = ({ children, className = "", onClick }) => (
  <motion.div
    ...
    whileTap={{ scale: 0.95 }} // ✅ NEW: Click karne par card thoda press hoga
    transition={{ type: "spring", stiffness: 300, damping: 20 }} // ✅ NEW: Smooth spring animation
    className={`bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-xl hover:shadow-purple-500/10 hover:border-purple-500/30 cursor-pointer ${className}`}
  >
    {children}
  </motion.div>
);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white selection:bg-purple-500/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              {user ? (
                <motion.button // ✅ NEW: Animated Button
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <section className="py-16 md:py-20 text-center">
          ...
          >
            ...
            <div className="pt-4 flex justify-center gap-4">
              <motion.a // ✅ NEW: Animated Button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href="#courses" 
                className="px-6 py-3 bg-purple-600 hover:bg-purple-500 text-white rounded-xl font-semibold transition-all shadow-lg shadow-purple-900/20"
              >
                Explore Courses
              </motion.a>
              {!user && (
                <motion.a // ✅ NEW: Animated Button
                  ...
                  whileTap={{ scale: 0.95 }}
                  href="/websiteloginpage" 
                  className="px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white rounded-xl font-semibold transition-all border border-gray-700"
                >
                  Sign In
                </motion.a>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <GlassCard className="p-6 cursor-default" onClick={() => {}}> {/* No click effect for stats */}
          ...
          <GlassCard className="p-6 cursor-default" onClick={() => {}}>
            <div className="flex items-center gap-4">
            ...
            <AnimatePresence>
              {grouped.map((course, index) => (
                <motion.div
                  ...
                  className="h-full"
                >
                  {/* GlassCard pe ab click animation active hai */}
                  <GlassCard 
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-700/50 mt-auto">
                        ...
                        <motion.div 
                          ...
                          className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-purple-500 hover:text-white transition-colors"
                        >
        ...
        <div className="mt-24 mb-12">
          ...
          <GlassCard className="relative p-8 overflow-hidden group cursor-not-allowed hover:shadow-none hover:scale-100" onClick={null}>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="relative">
                ...
                <button disabled className="px-8 py-4 bg-gray-800/50 border border-gray-700 text-gray-500 rounded-xl font-bold flex items-center gap-2 backdrop-blur-md cursor-not-allowed">
