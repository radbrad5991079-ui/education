    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white">
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-6">
          ...
          >
            {/* Back Button with Click Animation */}
            <motion.div 
              className="mb-6 inline-block" 
              whileHover={{ x: -5 }}
              whileTap={{ scale: 0.95 }} // ✅ ADDED: Click effect
            >
              <a
            ...
            <div className="flex flex-col lg:flex-row items-start gap-6">
              ...
              >
                ...
                {/* Course Stats (Interactive) */}
                <div className="flex flex-wrap items-center gap-4 mb-6">
                  <motion.div
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-600/20 border border-purple-500/30 cursor-default"
                  ...
                  <motion.div
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-pink-600/20 border border-pink-500/30 cursor-default"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }} // ✅ ADDED: Click effect
                  >
                  ...
                  {course.visibility === "show" && (
                    <motion.div
                      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600/20 border border-emerald-500/30 cursor-default"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }} // ✅ ADDED: Click effect
                    >
                ...
                <div className="flex flex-wrap gap-3">
                  {/* Wrapper for click animation on the Custom Button */}
              ...
              return (
                ...
                >
                  <AnimatedCard variant="glass">
                    {/* Section Header with Tap Animation */}
                    <motion.button
                      onClick={() => toggleSection(sIdx)}
                      whileTap={{ scale: 0.98 }} // ✅ ADDED: Subtle shrink on section click
                      transition={{ type: "spring", stiffness: 400, damping: 30 }}
                      className="w-full p-6 flex items-center justify-between hover:bg-white/5 transition-colors rounded-t-2xl outline-none"
                    >
                                ...
                                return (
                                  ...
                                  >
                                    <motion.a
                                      ...
                                      whileTap={
                                        // ✅ UPDATED: Consistent click feedback
                                        isLink && isEnabled 
                                            ? { scale: 0.95 } // Press when ready
                                            : (isLink && countdown == null 
                                                ? { scale: 0.95 } // Press to start countdown
                                                : {})
                                      }
                                    >
